...
from core_api.modules.signature_request.workflow_schema import ClientEvidence, GeolocationEvidence, SignCommand, StampPosition
...
def test_serpro_authorization_binds_one_signer_and_uses_pkce(monkeypatch) -> None:
    ...
    context = SimpleNamespace(
        request=SimpleNamespace(id=request_id, status="open", signer_count=1, signed_count=0, document_sha256="a" * 64),
