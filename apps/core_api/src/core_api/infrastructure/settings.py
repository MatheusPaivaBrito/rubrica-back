...
class Settings(BaseSettings):
    ...
    STRIPE_PRICE_ANNUAL_BRL: str | None = None
    STRIPE_PRICE_ANNUAL_USD: str | None = None
    STRIPE_PRICE_ANNUAL_EUR: str | None = None
    STRIPE_PRICE_ANNUAL_JPY: str | None = None
    ...
    STRIPE_PRICE_INTERMEDIATE_ANNUAL_BRL: str | None = None
    STRIPE_PRICE_INTERMEDIATE_ANNUAL_USD: str | None = None
    STRIPE_PRICE_INTERMEDIATE_ANNUAL_EUR: str | None = None
    STRIPE_PRICE_INTERMEDIATE_ANNUAL_JPY: str | None = None
